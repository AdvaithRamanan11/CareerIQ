...
export default function LoanROI() {
  const { college, setCollege, major, setMajor, job, setJob, area, setArea, region, setRegion, experience, setExperience, loanSnapshot } = useStore()
  ...
  const annualSalary = useMemo(() =>
    calculateSalary({ college, job: jobObj, area, experience, region }),
    [college, jobObj, area, experience, region]
  )
